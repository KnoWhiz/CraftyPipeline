...
\usetheme{JuanLesPins} % Leafy, organic feel
\usecolortheme{seagull} % Greyscale to accentuate content over color
\setbeamertemplate{items}[ball] % Round, natural shapes for bullet points
\setbeamercolor{block title}{fg=black,bg=green!30!white} % Earthy block titles
\setbeamercolor{background canvas}{bg=lime!10} % Soft, natural background
