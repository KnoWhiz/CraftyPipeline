...
\usetheme{Berkeley} % Side navigation for a structured look
\usecolortheme{dolphin} % Deep blues reminiscent of the night sky
\setbeamercolor{sidebar}{bg=black!70,fg=white} % Dark sidebar like the void of space
\setbeamertemplate{navigation symbols}{} % Simplify to focus on the stars
