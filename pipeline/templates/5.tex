...
\usetheme{Singapore} % Clean theme with slide titles on a navigation bar
\usecolortheme{crane} % Distinctive orange and dark gray, good for contrast
\usefonttheme{default} % Keeps the default Beamer font for simplicity
\useinnertheme{circles} % Uses circles for bullet points for a soft appearance
\useoutertheme{sidebar} % Adds a sidebar for section navigation, omitted in Singapore by default but can be added for other themes or customized
