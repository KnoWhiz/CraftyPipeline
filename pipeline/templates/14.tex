...
\usetheme{Singapore} % Clean lines and unobtrusive navigation
\usecolortheme{dove} % Pure monochromatic color theme for simplicity
\setbeamertemplate{navigation symbols}{} % Remove all navigation symbols for a minimalist design
\setbeamercolor{frametitle}{fg=black,bg=white} % Stark contrast for readability
\setbeamertemplate{footline} % Simplified footline with just essential info
