...
\usetheme{Szeged} % Structured with a strong border for focus
\usecolortheme{seahorse} % Soft, muted tones like aged paper
\setbeamercolor{background canvas}{bg=green!30!black} % Chalkboard green background
\setbeamercolor{normal text}{fg=white} % White text to mimic chalk
\setbeamertemplate{items}[circle] % Simple, unobtrusive bullet points
