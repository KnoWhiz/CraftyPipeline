...
\usetheme{Ilmenau} % Futuristic sidebar and bullet navigation
\usecolortheme{dove} % Monochromatic scheme for a modern look
\setbeamertemplate{footline}[frame number] % Minimalist footline with just frame numbers
\setbeamercolor{title}{fg=blue!80, bg=black!60} % Title styling reminiscent of tech themes
\setbeamercolor{section in sidebar}{fg=black,bg=white} % Sidebar sections for easy navigation
