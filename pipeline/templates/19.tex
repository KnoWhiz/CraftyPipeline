...
\usetheme{AnnArbor} % Cozy and inviting with a strong title block
\usecolortheme{beaver} % Warm, bread-like colors
\setbeamercolor{normal text}{fg=brown} % Text color like chocolate swirls in dough
\setbeamertemplate{navigation symbols}{} % Focus on the aroma, not the navigation
