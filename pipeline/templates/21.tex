...
\usetheme{Antibes} % Open and structured layout
\usecolortheme{beaver} % Earthy, autumnal tones
\setbeamercolor{structure}{fg=orange!75} % Elements inspired by autumn leaves
\setbeamercolor{normal text}{fg=brown!80} % Rich text color like fertile earth
\setbeamercolor{block title}{bg=orange!30, fg=black} % Harvest-themed blocks
