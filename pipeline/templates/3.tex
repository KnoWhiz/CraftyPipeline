...
\usefonttheme{serif} % Using a serif font for a more traditional look
\useinnertheme{circles} % Bullet lists and enumerations use circles
\useoutertheme{infolines} % Adds informative lines at the top or bottom
