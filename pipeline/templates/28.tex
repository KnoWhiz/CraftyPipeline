...
\usetheme{AnnArbor} % Strong and clear, with room for detailed content
\usecolortheme{beetle} % Earthy tones for a historical feel
\setbeamercolor{structure}{fg=brown!60} % Echoes of ancient pottery and texts
\setbeamercolor{normal text}{fg=brown!50} % Soft, as if faded by time
\setbeamercolor{titlelike}{fg=red!60} % Titles that draw attention like precious artifacts
