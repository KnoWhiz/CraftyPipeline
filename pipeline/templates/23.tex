...
\usetheme{Berlin} % Modern and dynamic
\usecolortheme{seagull} % Greyscale for digital ambiance
\setbeamercolor{structure}{fg=red!70} % Matrix-inspired green for emphasis
\setbeamercolor{normal text}{fg=red!30} % Echoes of code on a black screen
\setbeamercolor{titlelike}{fg=red} % Bright, as if highlighted on the monitor
