...
\usetheme{Singapore} % Minimalist and focused
\usecolortheme{dove} % Soft greyscale to minimize distraction
\setbeamercolor{structure}{fg=blue!20} % Almost imperceptible blue for a calming effect
\setbeamercolor{normal text}{fg=black!70} % Dimmed text to reduce strain
\setbeamercolor{titlelike}{fg=black!80} % Slightly stronger titles for gentle emphasis
