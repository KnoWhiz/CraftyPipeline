...
\usetheme{Bergen} % Side-bar navigation for a distinctive look
\usecolortheme{rose} % Soft, elegant color scheme
\usefonttheme{serif} % Classic feel with serif fonts
\setbeamertemplate{background canvas}[vertical shading][bottom=red!20,top=blue!10] % Retro gradient background
\setbeamercolor{block title}{use=structure,fg=white,bg=red!75!black} % Title blocks with a vintage vibe
