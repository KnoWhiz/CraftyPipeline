...
\usetheme{Madrid} % Bold and clear for impactful headings
\usecolortheme{orchid} % Bright purples for a neon effect
\setbeamercolor{section in head/foot}{bg=black, fg=pink!80} % Neon against dark backgrounds
\setbeamertemplate{navigation symbols}{} % Clean view for modern aesthetics
\setbeamercolor{frametitle}{fg=yellow,bg=black} % Highlighted titles for emphasis
