...
\usetheme{Montpellier} % Elegant theme with a prominent tree-like navigation
\usecolortheme{dolphin} % A balanced blue and gray scheme for clarity
\usefonttheme{serif} % Serif font for a traditional academic appearance
\useinnertheme{rounded} % Rounded shapes for bullet points, softening the look
\useoutertheme{shadow} % Adds subtle shadows to boxes for depth
