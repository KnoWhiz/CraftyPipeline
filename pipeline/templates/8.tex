...
\usetheme{Boadilla} % Minimalist theme with a clean look
\usecolortheme{lily} % A white and blue color theme for a crisp appearance
\usefonttheme{structurebold} % Bold fonts for headings to stand out
\useinnertheme{rounded} % Rounded shapes for a friendly feel
\useoutertheme{split} % A split navigational bar for sectioning content neatly
