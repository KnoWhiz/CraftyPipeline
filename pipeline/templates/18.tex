...
\usetheme{Goettingen} % Sidebar navigation to resemble a diving depth chart
\usecolortheme{seagull} % Subdued colors for an underwater feel
\setbeamercolor{sidebar}{bg=blue!50} % Deep ocean blue sidebar
\setbeamercolor{titlelike}{parent=palette primary,fg=white} % Titles that stand out like sunbeams underwater
