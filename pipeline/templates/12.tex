...
\usetheme{Pittsburgh} % Clean, focused theme for art and images
\usecolortheme{orchid} % Deep colors to complement visual art
\setbeamertemplate{navigation symbols}{} % Remove navigation symbols for a clean look
\setbeamercolor{frametitle}{fg=green!60!black} % Frame titles like plaque descriptions in galleries
