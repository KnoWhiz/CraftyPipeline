...
\usetheme{Marburg} % Elegant vertical navigation
\usecolortheme{wolverine} % Muted golds and blues on off-white
\setbeamercolor{structure}{fg=brown!70} % Old ink for structural elements
\setbeamercolor{normal text}{fg=brown!80} % Text as if penned by a quill
\setbeamercolor{titlelike}{fg=brown!90} % Titles bold as if freshly inked
