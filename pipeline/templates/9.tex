...
\usetheme{Frankfurt} % Modern theme with a dynamic slide navigation bar
\usecolortheme{rose} % Soft pink and gray tones for a subtle color palette
\usefonttheme{professionalfonts} % Professional fonts for a clean look
\useinnertheme{rectangles} % Rectangular elements for a contemporary edge
\useoutertheme{smoothbars} % Smooth navigational bars for sleek transitions
