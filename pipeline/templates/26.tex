...
\usetheme{Montpellier} % Structured, yet light and airy
\usecolortheme{seagull} % Neutral with a hint of green for an eco vibe
\setbeamercolor{structure}{fg=black!50} % Green accents to signify growth
\setbeamercolor{normal text}{fg=black!40} % Soft green, reminiscent of new leaves
\setbeamercolor{titlelike}{fg=black!60} % Titles that stand out like the canopy of a forest
