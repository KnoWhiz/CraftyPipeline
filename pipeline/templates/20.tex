...
\usetheme{Rochester} % Bold and assertive frames
\usecolortheme{dolphin} % Deep blues for the night
\setbeamercolor{background canvas}{bg=black!80} % A dark backdrop for contrast
\setbeamercolor{normal text}{fg=gray!10} % Softly illuminated text
\setbeamercolor{titlelike}{fg=cyan!50} % Titles glow like moonlight
