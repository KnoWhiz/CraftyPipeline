...
\usetheme{Copenhagen} % Clean and structured
\usecolortheme{dove} % Monochrome for blueprint clarity
\setbeamercolor{structure}{fg=blue!60} % Structural elements in blueprint blue
\setbeamercolor{normal text}{fg=blue!30} % Text as if drawn in light marker
\setbeamercolor{titlelike}{fg=blue!80} % Title stands out like a bold line
