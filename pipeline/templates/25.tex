...
\usetheme{Ilmenau} % Forward-looking with a strong navigational presence
\usecolortheme{orchid} % Deep purples to suggest the unknown
\setbeamercolor{structure}{fg=purple!80} % Elements that hint at quantum mysteries
\setbeamercolor{normal text}{fg=purple!60} % Text in the color of distant galaxies
\setbeamercolor{titlelike}{fg=black} % Titles that command attention like cosmic events
